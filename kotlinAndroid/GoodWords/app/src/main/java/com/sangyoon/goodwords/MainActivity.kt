package com.sangyoon.goodwords
...
import com.sangyoon.goodwords.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sentenceList.add("자기 아이에게 육체적 노동을 가르치지 않는 것은 약타과 강도를 가르치는 것과 마찬가지다.")
        sentenceList.add("승자는 눈에 밟아 길을 만들지만 패자는 눈이 녹기를 기다린다.")
        sentenceList.add("두 개의 화살을 갖지 마라. 두 번째 화살이 있기 때문에 첫 번째 화살에 집중하지 않게 된다.")
        sentenceList.add("그 사람 입장에 서기 전까지 덜대 그 사람을 욕하거나 책망하지 마라.")
        sentenceList.add("뛰어난 말에게도 채찍이 필요하다.")

        Log.d("MainAcvivity", sentenceList.random())
