...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       val bookmarkButton = findViewById<TextView>(R.id.bookmarkBtn)
        ...
        items.add(
            ContentsModel("https://www.mangoplate.com/restaurants/bKBEWmF8MVGb",
        ...
        items.add(
            ContentsModel("https://www.mangoplate.com/restaurants/pVydRWGId3d8",
                "https://mp-seoul-image-production-s3.mangoplate.com/708415_1655541518704179.jpg?fit=around|512:512&crop=512:512;*,*&output-format=jpg&output-quality=80",
                "피자보이시나"
            )
        )
        items.add(
            ContentsModel("https://www.mangoplate.com/restaurants/mmhYgR5FVnYH",
